...
Enter new data : 99
Enter data of the node before which new node is to be created : 54
...
Enter new data : 7 
Enter data of the node after which new node is to be created : 99
...
Enter data of the node to be deleted : 7
